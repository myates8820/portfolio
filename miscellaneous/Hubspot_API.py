...
""" This file is a connector I built for Hubspot due to them not having an out-of-box python connector at the time (or at least a useful one). I've been thinking about packaging
and actually putting it up on PyPi, but for now I just keep it locally. Anyone can use this as it just requires your API key and a list of properties you wish to pull from
Hubspot and then returns a list with those properties if .parse_{object_type}. Currently only for contacts and deals  """
